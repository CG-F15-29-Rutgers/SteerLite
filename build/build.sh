...
if [[ $BUILD_MODULE == "all" || $BUILD_MODULE == "sfAI_Rut29" ]]; then
    echo "==================================="
    echo "Building SOCIAL FORCES (Rut29) module"
    echo "==================================="
...
if [ $CURVEAI_BUILD_RETURN_CODE == 0 ]; then
    ...
    cp ../curveAI/build/curveAI.o $MODULES_DIR
...
if [ $SOCIAL_FORCES_BUILD_RETURN_CODE == 0 ]; then
    echo "copying sfAI_Rut29.o to $MODULES_DIR"
    cp ../sfAI_Rut29/build/sfAI_Rut29.o $MODULES_DIR
    SOCIAL_FORCES_INSTALL_RETURN_CODE=$?
fi
